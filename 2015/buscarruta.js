...
function init() {
    ...
    var features = [new OpenLayers.Geometry.Point(-4.61325, 41.65132), new OpenLayers.Geometry.Point(-4.61324, 41.65120)];

/*		    var features = [new OpenLayers.Feature.Vector(OpenLayers.Geometry.fromWKT(
        'POINT(-4.61325 41.65132)'
    )),new OpenLayers.Feature.Vector(OpenLayers.Geometry.fromWKT(
        'POINT(-4.61324 41.65120)'];
		*/
    ...
    intersect = client.getProcess('cartociudad', 'org.cnig.cartociudad.wps.RouteFinder');    
    intersect.execute({
		...
		success: function(outputs) {
            ...
            // processes.
            map.baseLayer.addFeatures(outputs.routeResult);
        }
    });
