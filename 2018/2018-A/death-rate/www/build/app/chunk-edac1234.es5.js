...
App.loadBundle("chunk-edac1234.js", ["require", "exports"], function (n, e) { window.App.h; function i(n, e) {
    ...
    e.dispatchEvent(t_1);
} } function r(n) { return n && n.componentOnReady ? n.componentOnReady() : Promise.resolve(); } function s(n) {
    return __awaiter(this, void 0, void 0, function () { var e, _a; return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                e = n;
                if (!e) return [3 /*break*/, 4];
                _a = e.componentOnReady;
                if (!_a) return [3 /*break*/, 2];
            ...
            case 2:
                if (_a)
                    return [2 /*return*/];
                return [4 /*yield*/, Promise.all(Array.from(e.children).map(s))];
            case 3:
                _b.sent();
                _b.label = 4;
...
} e.hapticSelectionChanged = function () { var n = window.TapticEngine; n && n.gestureSelectionChanged(); }, e.attachComponent = function (n, e, i, t, a) {
    return __awaiter(this, void 0, void 0, function () { var o, _a; return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (n)
                    return [2 /*return*/, n.attachViewToDom(e, i, a, t)];
                if ("string" != typeof i && !(i instanceof HTMLElement))
                    throw new Error("framework delegate is missing");
                o = "string" == typeof i ? e.ownerDocument.createElement(i) : i;
                t && t.forEach(function (n) { return o.classList.add(n); }), a && Object.assign(o, a), e.appendChild(o);
                _a = o.componentOnReady;
                if (!_a) return [3 /*break*/, 2];
                return [4 /*yield*/, o.componentOnReady()];
            case 1:
                _a = (_b.sent());
                _b.label = 2;
            case 2: return [2 /*return*/, (_a, o)];
        }
    }); });
}, e.detachComponent = function (n, e) { if (e) {
    if (n) {
        var i_1 = e.parentElement;
        return n.removeViewFromDom(i_1, e);
    }
    e.remove();
} return Promise.resolve(); }, e.transition = function (e) {
    var _this = this;
    return new Promise(function (o) { e.queue.write(function () { return __awaiter(_this, void 0, void 0, function () { var r, s; return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
