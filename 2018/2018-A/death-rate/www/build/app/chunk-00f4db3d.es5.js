...
App.loadBundle("chunk-00f4db3d.js", ["exports"], function (e) { function t(e, t) { return e(t = { exports: {} }, t.exports), t.exports; } window.App.h; var r = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, n = new RegExp("[\\-\\.0-9" + r.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), i = new RegExp("^" + r.source + n.source + "*(?::" + r.source + n.source + "*)?$"), a = 0, o = 1, s = 2, l = 3, c = 4, u = 5, h = 6, f = 7; function d() { } function p(e, t) { return t.lineNumber = e.lineNumber, t.columnNumber = e.columnNumber, t; } function m(e, t, r, n, i, d) { for (var p, m = ++t, g = a;;) {
    ...
    return i ? (i[0].length, r.processingInstruction(i[1], i[2]), n + 2) : -1;
        ...
        try {
            ...
            switch ((N > b && o(N), e.charAt(N + 1))) {
                case "/":
                    var T = e.indexOf(">", N + 3), x = e.substring(N + 2, T), k = f.pop();
                    T < 0 ? (x = e.substring(N + 2).replace(/[\s<].*/, ""), i.error("end tag name: " + x + " is not complete:" + k.tagName), T = N + 1 + x.length) : x.match(/\s</) && (x = x.replace(/[\s<].*/, ""), i.error("end tag name: " + x + " maybe not complete"), T = N + 1 + x.length);
                    var I = k.localNSMap, A = k.tagName == x;
                    if (A || k.tagName && k.tagName.toLowerCase() == x.toLowerCase()) {
                        if (n.endElement(k.uri, k.localName, x), I)
                            for (var C in I)
                                n.endPrefixMapping(C);
                        A || i.fatalError("end tag name: " + x + " is not match the current start tagName:" + k.tagName);
                    }
                    else
                        f.push(k);
                    T++;
                ...
                default:
                    h && s(N);
                    var O = new E, R = f[f.length - 1].currentNSMap, L = (T = m(e, N, O, R, a, i), O.length);
                    if (!O.closed && y(e, T, O.tagName, d) && (O.closed = !0, r.nbsp || i.warning("unclosed xml attribute")), h && L) {
                        for (var M = p(h, {}), F = 0; F < L; F++) {
                            var B = O[F];
                            s(B.offset), B.locator = p(h, {});
                        }
                        n.locator = M, g(O, n, R) && f.push(O), n.locator = h;
                    }
                    else
                        g(O, n, R) && f.push(O);
    ...
    t[r] = e[r]; } function k(e, t) { var r = e.prototype; if (Object.create) {
    var n = Object.create(t.prototype);
    r.__proto__ = n;
} if (!(r instanceof t)) {
    function i() { }
    i.prototype = t.prototype, x(r, i = new i), e.prototype = r = i;
} r.constructor != e && ("function" != typeof e && console.error("unknow Class:" + e), r.constructor = e); } var I = "http://www.w3.org/1999/xhtml", A = {}, C = A.ELEMENT_NODE = 1, O = A.ATTRIBUTE_NODE = 2, R = A.TEXT_NODE = 3, L = A.CDATA_SECTION_NODE = 4, M = A.ENTITY_REFERENCE_NODE = 5, F = A.ENTITY_NODE = 6, B = A.PROCESSING_INSTRUCTION_NODE = 7, U = A.COMMENT_NODE = 8, P = A.DOCUMENT_NODE = 9, G = A.DOCUMENT_TYPE_NODE = 10, Z = A.DOCUMENT_FRAGMENT_NODE = 11, K = A.NOTATION_NODE = 12, V = {}, j = {}, z = (V.INDEX_SIZE_ERR = (j[1] = "Index size error", 1), V.DOMSTRING_SIZE_ERR = (j[2] = "DOMString size error", 2), V.HIERARCHY_REQUEST_ERR = (j[3] = "Hierarchy request error", 3)), H = (V.WRONG_DOCUMENT_ERR = (j[4] = "Wrong document", 4), V.INVALID_CHARACTER_ERR = (j[5] = "Invalid character", 5), V.NO_DATA_ALLOWED_ERR = (j[6] = "No data allowed", 6), V.NO_MODIFICATION_ALLOWED_ERR = (j[7] = "No modification allowed", 7), V.NOT_FOUND_ERR = (j[8] = "Not found", 8)), Y = (V.NOT_SUPPORTED_ERR = (j[9] = "Not supported", 9), V.INUSE_ATTRIBUTE_ERR = (j[10] = "Attribute in use", 10)); function W(e, t) { if (t instanceof Error)
    var r = t;
else
    ...
    case M: return t.push("&", e.nodeName, ";");
    default: t.push("??", e.nodeName);
        ...
        Te(this[n], r, e, t); return r.join(""); } }, $.prototype.item = function (e) { return q(this), this[e]; }, k($, X), Q.prototype = { length: 0, item: X.prototype.item, getNamedItem: function (e) { for (var t = this.length; t--;) {
        var r = this[t];
        if (r.nodeName == e)
            return r;
        ...
        if (r && e in r)
            return r[e];
        t = t.nodeType == O ? t.ownerDocument : t.parentNode;
    } return null; }, isDefaultNamespace: function (e) { return null == this.lookupPrefix(e); } }, x(A, ne), x(A, ne.prototype), oe.prototype = { nodeName: "#document", nodeType: P, doctype: null, documentElement: null, _inc: 1, insertBefore: function (e, t) { if (e.nodeType == Z) {
...
catch (e) { } var ke, Ie = re, Ae = Ne, Ce = { DOMImplementation: Ie, XMLSerializer: Ae }, Oe = Object.freeze({ default: Ce, __moduleExports: Ce, DOMImplementation: Ie, XMLSerializer: Ae }), Re = T && D || T, Le = Oe && Ce || Oe, Me = t(function (e, t) { function r(e) { this.options = e || { locator: {} }; } function n() { this.cdata = !1; } function i(e, t) { t.lineNumber = e.lineNumber, t.columnNumber = e.columnNumber; } function a(e) { if (e)
    ...
    } }, warning: function (e) { console.warn("[xmldom warning]\t" + e, a(this.locator)); }, error: function (e) { console.error("[xmldom error]\t" + e, a(this.locator)); }, fatalError: function (e) { throw console.error("[xmldom fatalError]\t" + e, a(this.locator)), e; } }, "endDTD,startEntity,endEntity,attributeDecl,elementDecl,externalEntityDecl,internalEntityDecl,resolveEntity,getExternalSubset,notationDecl,unparsedEntityDecl".replace(/\w+/g, function (e) { n.prototype[e] = function () { return null; }; }); var l = Re.XMLReader, c = t.DOMImplementation = Le.DOMImplementation; t.XMLSerializer = Le.XMLSerializer, t.DOMParser = r; }), Fe = Me.DOMImplementation, Be = Me.XMLSerializer, Ue = Me.DOMParser, Pe = Object.freeze({ default: Me, __moduleExports: Me, DOMImplementation: Fe, XMLSerializer: Be, DOMParser: Ue }), Ge = Pe && Me || Pe, Ze = { 315: "Artist", 258: "BitsPerSample", 265: "CellLength", 264: "CellWidth", 320: "ColorMap", 259: "Compression", 33432: "Copyright", 306: "DateTime", 338: "ExtraSamples", 266: "FillOrder", 289: "FreeByteCounts", 288: "FreeOffsets", 291: "GrayResponseCurve", 290: "GrayResponseUnit", 316: "HostComputer", 270: "ImageDescription", 257: "ImageLength", 256: "ImageWidth", 271: "Make", 281: "MaxSampleValue", 280: "MinSampleValue", 272: "Model", 254: "NewSubfileType", 274: "Orientation", 262: "PhotometricInterpretation", 284: "PlanarConfiguration", 296: "ResolutionUnit", 278: "RowsPerStrip", 277: "SamplesPerPixel", 305: "Software", 279: "StripByteCounts", 273: "StripOffsets", 255: "SubfileType", 263: "Threshholding", 282: "XResolution", 283: "YResolution", 326: "BadFaxLines", 327: "CleanFaxData", 343: "ClipPath", 328: "ConsecutiveBadFaxLines", 433: "Decode", 434: "DefaultImageColor", 269: "DocumentName", 336: "DotRange", 321: "HalftoneHints", 346: "Indexed", 347: "JPEGTables", 285: "PageName", 297: "PageNumber", 317: "Predictor", 319: "PrimaryChromaticities", 532: "ReferenceBlackWhite", 339: "SampleFormat", 340: "SMinSampleValue", 341: "SMaxSampleValue", 559: "StripRowCounts", 330: "SubIFDs", 292: "T4Options", 293: "T6Options", 325: "TileByteCounts", 323: "TileLength", 324: "TileOffsets", 322: "TileWidth", 301: "TransferFunction", 318: "WhitePoint", 344: "XClipPathUnits", 286: "XPosition", 529: "YCbCrCoefficients", 531: "YCbCrPositioning", 530: "YCbCrSubSampling", 345: "YClipPathUnits", 287: "YPosition", 37378: "ApertureValue", 40961: "ColorSpace", 36868: "DateTimeDigitized", 36867: "DateTimeOriginal", 34665: "Exif IFD", 36864: "ExifVersion", 33434: "ExposureTime", 41728: "FileSource", 37385: "Flash", 40960: "FlashpixVersion", 33437: "FNumber", 42016: "ImageUniqueID", 37384: "LightSource", 37500: "MakerNote", 37377: "ShutterSpeedValue", 37510: "UserComment", 33723: "IPTC", 34675: "ICC Profile", 700: "XMP", 42112: "GDAL_METADATA", 42113: "GDAL_NODATA", 34377: "Photoshop", 33550: "ModelPixelScale", 33922: "ModelTiepoint", 34264: "ModelTransformation", 34735: "GeoKeyDirectory", 34736: "GeoDoubleParams", 34737: "GeoAsciiParams" }, Ke = {}; for (ke in Ze)
    Ke[Ze[ke]] = parseInt(ke); var Ve = [Ke.BitsPerSample, Ke.ExtraSamples, Ke.SampleFormat, Ke.StripByteCounts, Ke.StripOffsets, Ke.StripRowCounts, Ke.TileByteCounts, Ke.TileOffsets], je = { 1: "BYTE", 2: "ASCII", 3: "SHORT", 4: "LONG", 5: "RATIONAL", 6: "SBYTE", 7: "UNDEFINED", 8: "SSHORT", 9: "SLONG", 10: "SRATIONAL", 11: "FLOAT", 12: "DOUBLE", 16: "LONG8", 17: "SLONG8", 18: "IFD8" }, ze = {}; for (ke in je)
    ze[je[ke]] = parseInt(ke); var He, Ye = { 1024: "GTModelTypeGeoKey", 1025: "GTRasterTypeGeoKey", 1026: "GTCitationGeoKey", 2048: "GeographicTypeGeoKey", 2049: "GeogCitationGeoKey", 2050: "GeogGeodeticDatumGeoKey", 2051: "GeogPrimeMeridianGeoKey", 2052: "GeogLinearUnitsGeoKey", 2053: "GeogLinearUnitSizeGeoKey", 2054: "GeogAngularUnitsGeoKey", 2055: "GeogAngularUnitSizeGeoKey", 2056: "GeogEllipsoidGeoKey", 2057: "GeogSemiMajorAxisGeoKey", 2058: "GeogSemiMinorAxisGeoKey", 2059: "GeogInvFlatteningGeoKey", 2060: "GeogAzimuthUnitsGeoKey", 2061: "GeogPrimeMeridianLongGeoKey", 2062: "GeogTOWGS84GeoKey", 3072: "ProjectedCSTypeGeoKey", 3073: "PCSCitationGeoKey", 3074: "ProjectionGeoKey", 3075: "ProjCoordTransGeoKey", 3076: "ProjLinearUnitsGeoKey", 3077: "ProjLinearUnitSizeGeoKey", 3078: "ProjStdParallel1GeoKey", 3079: "ProjStdParallel2GeoKey", 3080: "ProjNatOriginLongGeoKey", 3081: "ProjNatOriginLatGeoKey", 3082: "ProjFalseEastingGeoKey", 3083: "ProjFalseNorthingGeoKey", 3084: "ProjFalseOriginLongGeoKey", 3085: "ProjFalseOriginLatGeoKey", 3086: "ProjFalseOriginEastingGeoKey", 3087: "ProjFalseOriginNorthingGeoKey", 3088: "ProjCenterLongGeoKey", 3089: "ProjCenterLatGeoKey", 3090: "ProjCenterEastingGeoKey", 3091: "ProjCenterNorthingGeoKey", 3092: "ProjScaleAtNatOriginGeoKey", 3093: "ProjScaleAtCenterGeoKey", 3094: "ProjAzimuthAngleGeoKey", 3095: "ProjStraightVertPoleLongGeoKey", 3096: "ProjRectifiedGridAngleGeoKey", 4096: "VerticalCSTypeGeoKey", 4097: "VerticalCitationGeoKey", 4098: "VerticalDatumGeoKey", 4099: "VerticalUnitsGeoKey" }, We = {}; for (ke in Ye)
    We[Ye[ke]] = parseInt(ke); "undefined" == typeof window ? He = function (e) { return (new (0, Ge.DOMParser)).parseFromString(e, "text/xml"); } : void 0 !== window.DOMParser ? He = function (e) { return (new window.DOMParser).parseFromString(e, "text/xml"); } : void 0 !== window.ActiveXObject && new window.ActiveXObject("Microsoft.XMLDOM") && (He = function (e) { var t = new window.ActiveXObject("Microsoft.XMLDOM"); return t.async = "false", t.loadXML(e), t; }); var Xe = { fieldTags: Ke, fieldTagNames: Ze, arrayFields: Ve, fieldTypes: ze, fieldTypeNames: je, photometricInterpretations: { WhiteIsZero: 0, BlackIsZero: 1, RGB: 2, Palette: 3, TransparencyMask: 4, CMYK: 5, YCbCr: 6, CIELab: 8, ICCLab: 9 }, geoKeys: We, geoKeyNames: Ye, parseXml: He }, $e = Xe.fieldTags, qe = Xe.fieldTagNames, Qe = Xe.arrayFields, Je = Xe.fieldTypes, et = Xe.fieldTypeNames, tt = Xe.photometricInterpretations, rt = Xe.geoKeys, nt = Xe.geoKeyNames, it = Xe.parseXml, at = Object.freeze({ default: Xe, __moduleExports: Xe, fieldTags: $e, fieldTagNames: qe, arrayFields: Qe, fieldTypes: Je, fieldTypeNames: et, photometricInterpretations: tt, geoKeys: rt, geoKeyNames: nt, parseXml: it }), ot = { fromWhiteIsZero: function (e, t, r, n) { for (var i, a = new Uint8Array(r * n * 3), o = 0, s = 0; o < e.length; ++o, s += 3)
    ...
    if (r) {
        ...
        e[i + a] = t[r + a]; }, flattenChunks: function (e) { return [].concat.apply([], e); } }; t.setTyped = function (e) { e ? (t.Buf8 = Uint8Array, t.Buf16 = Uint16Array, t.Buf32 = Int32Array, t.assign(t, i)) : (t.Buf8 = Array, t.Buf16 = Array, t.Buf32 = Array, t.assign(t, a)); }, t.setTyped(r); }), Tt = Dt.assign, xt = Dt.shrinkBuf, kt = Dt.setTyped, It = Dt.Buf8, At = Dt.Buf16, Ct = Dt.Buf32, Ot = Object.freeze({ default: Dt, __moduleExports: Dt, assign: Tt, shrinkBuf: xt, setTyped: kt, Buf8: It, Buf16: At, Buf32: Ct }), Rt = function (e, t, r, n) { for (var i = 65535 & e | 0, a = e >>> 16 & 65535 | 0, o = 0; 0 !== r;) {
    r -= o = r > 2e3 ? 2e3 : r;
    do {
        a = a + (i = i + t[n++] | 0) | 0;
    } while (--o);
    i %= 65521, a %= 65521;
} return i | a << 16 | 0; }, Lt = Object.freeze({ default: Rt, __moduleExports: Rt }), Mt = function () { for (var e, t = [], r = 0; r < 256; r++) {
    e = r;
    for (var n = 0; n < 8; n++)
        e = 1 & e ? 3988292384 ^ e >>> 1 : e >>> 1;
    t[r] = e;
} return t; }(), Ft = function (e, t, r, n) { var i = Mt, a = n + r; e ^= -1; for (var o = n; o < a; o++)
    e = e >>> 8 ^ i[255 & (e ^ t[o])]; return -1 ^ e; }, Bt = Object.freeze({ default: Ft, __moduleExports: Ft }), Ut = function (e, t) { var r, n, i, a, o, s, l, c, u, h, f, d, p, m, g, w, y, b, v, _, E, N, S, D, T; r = e.state, n = e.next_in, D = e.input, i = n + (e.avail_in - 5), a = e.next_out, T = e.output, o = a - (t - e.avail_out), s = a + (e.avail_out - 257), l = r.dmax, c = r.wsize, u = r.whave, h = r.wnext, f = r.window, d = r.hold, p = r.bits, m = r.lencode, g = r.distcode, w = (1 << r.lenbits) - 1, y = (1 << r.distbits) - 1; e: do {
...
} while (n < i && a < s); n -= _ = p >> 3, d &= (1 << (p -= _ << 3)) - 1, e.next_in = n, e.next_out = a, e.avail_in = n < i ? i - n + 5 : 5 - (n - i), e.avail_out = a < s ? s - a + 257 : 257 - (a - s), r.hold = d, r.bits = p; }, Pt = Object.freeze({ default: Ut, __moduleExports: Ut }), Gt = Ot && Dt || Ot, Zt = [3, 4, 5, 6, 7, 8, 9, 10, 11, 13, 15, 17, 19, 23, 27, 31, 35, 43, 51, 59, 67, 83, 99, 115, 131, 163, 195, 227, 258, 0, 0], Kt = [16, 16, 16, 16, 16, 16, 16, 16, 17, 17, 17, 17, 18, 18, 18, 18, 19, 19, 19, 19, 20, 20, 20, 20, 21, 21, 21, 21, 16, 72, 78], Vt = [1, 2, 3, 4, 5, 7, 9, 13, 17, 25, 33, 49, 65, 97, 129, 193, 257, 385, 513, 769, 1025, 1537, 2049, 3073, 4097, 6145, 8193, 12289, 16385, 24577, 0, 0], jt = [16, 16, 16, 16, 17, 17, 18, 18, 19, 19, 20, 20, 21, 21, 22, 22, 23, 23, 24, 24, 25, 25, 26, 26, 27, 27, 28, 28, 29, 29, 64, 64], zt = function (e, t, r, n, i, a, o, s) { var l, c, u, h, f, d, p, m, g, w = s.bits, y = 0, b = 0, v = 0, _ = 0, E = 0, N = 0, S = 0, D = 0, T = 0, x = 0, k = null, I = 0, A = new Gt.Buf16(16), C = new Gt.Buf16(16), O = null, R = 0; for (y = 0; y <= 15; y++)
    A[y] = 0; for (b = 0; b < n; b++)
    A[t[r + b]]++; for (E = w, _ = 15; _ >= 1 && 0 === A[_]; _--)
    ; if (E > _ && (E = _), 0 === _)
    return i[a++] = 20971520, i[a++] = 20971520, s.bits = 1, 0; for (v = 1; v < _ && 0 === A[v]; v++)
    ; for (E < v && (E = v), D = 1, y = 1; y <= 15; y++)
    if (D <<= 1, (D -= A[y]) < 0)
        return -1; if (D > 0 && (0 === e || 1 !== _))
    return -1; for (C[1] = 0, y = 1; y < 15; y++)
    C[y + 1] = C[y] + A[y]; for (b = 0; b < n; b++)
    0 !== t[r + b] && (o[C[t[r + b]]++] = b); if (0 === e ? (k = O = o, d = 19) : 1 === e ? (k = Zt, I -= 257, O = Kt, R -= 257, d = 256) : (k = Vt, O = jt, d = -1), x = 0, b = 0, y = v, f = a, N = E, S = 0, u = -1, h = (T = 1 << E) - 1, 1 === e && T > 852 || 2 === e && T > 592)
    return 1; for (;;) {
    p = y - S, o[b] < d ? (m = 0, g = o[b]) : o[b] > d ? (m = O[R + o[b]], g = k[I + o[b]]) : (m = 96, g = 0), l = 1 << y - S, v = c = 1 << N;
    do {
        i[f + (x >> S) + (c -= l)] = p << 24 | m << 16 | g | 0;
    } while (0 !== c);
    for (l = 1 << y - 1; x & l;)
        l >>= 1;
    if (0 !== l ? (x &= l - 1, x += l) : x = 0, b++, 0 == --A[y]) {
        if (y === _)
            break;
        y = t[r + o[b]];
    }
    if (y > E && (x & h) !== u) {
        for (0 === S && (S = E), f += v, D = 1 << (N = y - S); N + S < _ && !((D -= A[N + S]) <= 0);)
            N++, D <<= 1;
        if (T += 1 << N, 1 === e && T > 852 || 2 === e && T > 592)
            return 1;
        i[u = x & h] = E << 24 | N << 16 | f - a | 0;
    }
} return 0 !== x && (i[f + x] = y - S << 24 | 64 << 16 | 0), s.bits = E, 0; }, Ht = Object.freeze({ default: zt, __moduleExports: zt }), Yt = Lt && Rt || Lt, Wt = Bt && Ft || Bt, Xt = Pt && Ut || Pt, $t = Ht && zt || Ht, qt = 1, Qt = 2, Jt = 0, er = -2, tr = 1, rr = 852, nr = 592; function ir(e) { return (e >>> 24 & 255) + (e >>> 8 & 65280) + ((65280 & e) << 8) + ((255 & e) << 24); } function ar(e) { var t; return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = tr, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new Gt.Buf32(rr), t.distcode = t.distdyn = new Gt.Buf32(nr), t.sane = 1, t.back = -1, Jt) : er; } function or(e) { var t; return e && e.state ? ((t = e.state).wsize = 0, t.whave = 0, t.wnext = 0, ar(e)) : er; } function sr(e, t) { var r, n; return e && e.state ? (n = e.state, t < 0 ? (r = 0, t = -t) : (r = 1 + (t >> 4), t < 48 && (t &= 15)), t && (t < 8 || t > 15) ? er : (null !== n.window && n.wbits !== t && (n.window = null), n.wrap = r, n.wbits = t, or(e))) : er; } function lr(e, t) { var r, n; return e ? (n = new function () { this.mode = 0, this.last = !1, this.wrap = 0, this.havedict = !1, this.flags = 0, this.dmax = 0, this.check = 0, this.total = 0, this.head = null, this.wbits = 0, this.wsize = 0, this.whave = 0, this.wnext = 0, this.window = null, this.hold = 0, this.bits = 0, this.length = 0, this.offset = 0, this.extra = 0, this.lencode = null, this.distcode = null, this.lenbits = 0, this.distbits = 0, this.ncode = 0, this.nlen = 0, this.ndist = 0, this.have = 0, this.next = null, this.lens = new Gt.Buf16(320), this.work = new Gt.Buf16(288), this.lendyn = null, this.distdyn = null, this.sane = 0, this.back = 0, this.was = 0; }, e.state = n, n.window = null, (r = sr(e, t)) !== Jt && (e.state = null), r) : er; } var cr, ur, hr = !0; function fr(e) { if (hr) {
    var t;
    ...
    xr = !1;
} for (var kr = new Gt.Buf8(256), Ir = 0; Ir < 256; Ir++)
    kr[Ir] = Ir >= 252 ? 6 : Ir >= 248 ? 5 : Ir >= 240 ? 4 : Ir >= 224 ? 3 : Ir >= 192 ? 2 : 1; kr[254] = kr[254] = 1; var Ar = function (e) { var t, r, n, i, a, o = e.length, s = 0; for (i = 0; i < o; i++)
    ...
    t[r] = e.charCodeAt(r); return t; }, Lr = function (e, t) { var r, n, i, a, o = t || e.length, s = new Array(2 * o); for (n = 0, r = 0; r < o;)
    if ((i = e[r++]) < 128)
        s[n++] = i;
    else if ((a = kr[i]) > 4)
        s[n++] = 65533, r += a - 1;
    ...
    throw new Error(Nn[r]); this.header = new Dn, vn.inflateGetHeader(this.strm, this.header); } function kn(e, t) { var r = new xn(t); if (r.push(e, !0), r.err)
...
} while ((l.avail_in > 0 || 0 === l.avail_out) && r !== En.Z_STREAM_END); return r === En.Z_STREAM_END && (n = En.Z_FINISH), n === En.Z_FINISH ? (r = vn.inflateEnd(this.strm), this.onEnd(r), this.ended = !0, r === En.Z_OK) : n !== En.Z_SYNC_FLUSH || (this.onEnd(En.Z_OK), l.avail_out = 0, !0); }, xn.prototype.onData = function (e) { this.chunks.push(e); }, xn.prototype.onEnd = function (e) { e === En.Z_OK && ("string" === this.options.to ? this.result = this.chunks.join("") : this.result = Gt.flattenChunks(this.chunks)), this.chunks = [], this.err = e, this.msg = this.strm.msg; }; var In = xn, An = kn, Cn = function (e, t) { return (t = t || {}).raw = !0, kn(e, t); }, On = kn, Rn = { Inflate: In, inflate: An, inflateRaw: Cn, ungzip: On }, Ln = Object.freeze({ default: Rn, __moduleExports: Rn, Inflate: In, inflate: An, inflateRaw: Cn, ungzip: On }), Mn = (Ln && Rn || Ln).inflate; function Fn() { } Fn.prototype = Object.create(wt.prototype), Fn.prototype.constructor = Fn, Fn.prototype.decodeBlock = function (e) { return Mn(new Uint8Array(e)).buffer; }; var Bn = Fn, Un = Object.freeze({ default: Bn, __moduleExports: Bn }); function Pn() { } Pn.prototype = Object.create(wt.prototype), Pn.prototype.constructor = Pn, Pn.prototype.decodeBlock = function (e) { var t, r, n = new DataView(e), i = []; for (t = 0; t < e.byteLength; ++t) {
    var a = n.getInt8(t);
    if (a < 0) {
        ...
        for (var y = u; y < h; ++y)
            for (var b = l; b < c; ++b)
                for (var v = y * s, _ = b * o, E = (y + 1) * s, N = (b + 1) * o, S = 0; S < t.length; ++S) {
                    ...
                    var T = new DataView(this.getTileOrStrip(b, y, D)), x = g[S], k = Math.min(s, s - (E - e[3])), I = Math.min(o, o - (N - e[2])), A = (k * o + I) * d, C = new Uint8Array(T.buffer).length;
                    2 * C !== A && this._debugMessages && console.warn("dimension mismatch", C, A);
                    for (var O = Math.max(0, e[1] - v); O < k; ++O)
                        for (var R = Math.max(0, e[0] - _); R < I; ++R) {
                            var L, M = (O * o + R) * d, F = 0;
                            M < C - 1 && (F = x.call(T, M + m[S], this.littleEndian)), n ? (1 !== p && R > 0 && (F += r[L = (O + v - e[1]) * f * t.length + (R + _ - e[0] - 1) * t.length + S]), r[L = (O + v - e[1]) * f * t.length + (R + _ - e[0]) * t.length + S] = F) : (1 !== p && R > 0 && (L = (O + v - e[1]) * f + R - 1 + _ - e[0], F += r[S][L]), L = (O + v - e[1]) * f + R + _ - e[0], r[S][L] = F);
                        }
                }
        return i(r), r;
    }
    ...
    if (this.bigTiff = !0, 8 !== this.dataView.getUint16(4, this.littleEndian))
        ...
        throw new RangeError("Invalid image index"); return new ri(t[0], t[1], this.dataView, this.littleEndian, this.cache); }, getImageCount: function () { return this.fileDirectories.length; } }; var ci = li, ui = Object.freeze({ default: ci, __moduleExports: ci }), hi = ui && ci || ui, fi = t(function (e) { var t = function (e, t) { var r, n, i, a; if ("string" == typeof e || e instanceof String)
    ...
    r = e;
} return new hi(r, t); }; e.exports.parse = t, "undefined" != typeof window && (window.GeoTIFF = { parse: t }); }).parse; e.getCurrentCoord = function (e, t) { if (!("geolocation" in navigator))
    throw new Error("geolocation not available"); return new Promise(function (r) { navigator.geolocation.getCurrentPosition(function (n) { r({ lat: n.coords.latitude, log: n.coords.longitude, angle: e, resolution: t }); }); }); }, e.process = function (e, t, r) {
    return __awaiter(this, void 0, void 0, function () { var n, i, a, e_1; return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Promise.all(e.map(function (e) { return (function (e, t) {
                    return __awaiter(this, void 0, void 0, function () { var r, n; return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                console.log(e.url);
                                return [4 /*yield*/, fetch(e.url, { method: "POST", body: function (e, t, r) {
            ...
            case 1:
                ...
                for (e_1 = 0; e_1 < i; e_1++)
                    a[e_1] = r.apply(void 0, [e_1].concat(n));
                return [2 /*return*/, a];
        }
    }); });
}, e.getExtends = function (e) { return [e.log - e.angle, e.lat - e.angle, e.log + e.angle, e.lat + e.angle]; }, e.SOURCES = [{ name: "volcanes", url: "//sedac.ciesin.org/geoserver/ows", coverage: "ndh:ndh-volcano-mortality-risks-distribution" }, { name: "corrimiento", url: "//sedac.ciesin.org/geoserver/ows", coverage: "ndh:ndh-landslide-mortality-risks-distribution" }, { name: "Inundaciones", url: "//sedac.ciesin.org/geoserver/ows", coverage: "ndh:ndh-flood-mortality-risks-distribution" }, { name: "Terremotos", url: "//sedac.ciesin.org/geoserver/ows", coverage: "ndh:ndh-earthquake-mortality-risks-distribution" }, { name: "Sequías", url: "//sedac.ciesin.org/geoserver/ows", coverage: "ndh:ndh-drought-mortality-risks-distribution" }, { name: "Ciclones", url: "//sedac.ciesin.org/geoserver/ows", coverage: "ndh:ndh-cyclone-mortality-risks-distribution" }, { name: "Malnutricion infantil", url: "//sedac.ciesin.org/geoserver/ows", coverage: "povmap:povmap-global-subnational-prevalence-child-malnutrition" }, { name: "Mortalidad infantil", url: "//sedac.ciesin.org/geoserver/ows", coverage: "povmap:povmap-global-subnational-infant-mortality-rates_2000" }], e.reduce = function (e, t, r, n, i, a, o, s, l) { return (t[e] + r[e] + n[e] + i[e] + a[e] + o[e] + s[e] + l[e]) / .08; }, e.insertQuery = function (e, t) {
    return __awaiter(this, void 0, void 0, function () { var r, n; return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                r = function (e, t) { return "\n  <wfs:Transaction service=\"WFS\" version=\"1.0.0\"\n  xmlns:wfs=\"http://www.opengis.net/wfs\"\n  xmlns:DeathRate=\"http://itastdevserver.tel.uva.es/IDE2018A\"\n  xmlns:gml=\"http://www.opengis.net/gml\"\n  xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n  xsi:schemaLocation=\"http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.0.0/WFS-transaction.xsd http://itastdevserver.tel.uva.es/IDE2018A " + e + "/wfs/DescribeFeatureType?typename=ide2018a:table_history\">\n  <wfs:Insert>\n    <DeathRate:table_history>\n      <DeathRate:position>\n          <gml:Point><gml:coordinates>" + t.coord.log + " " + t.coord.lat + "</gml:coordinates></gml:Point>\n      </DeathRate:position>\n      <DeathRate:username>" + t.name + "</DeathRate:username>\n   \t  <DeathRate:deathRate>" + t.deathRate + "</DeathRate:deathRate>\n   \t  <DeathRate:date>2018-12-12/DeathRate:date>\n    </DeathRate:table_history>\n  </wfs:Insert>\n</wfs:Transaction>"; }(e, t), n = e + "/ide2018a/ows";
                return [4 /*yield*/, fetch(n, { method: "POST", body: r })];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
