...
App.loadBundle("chunk-7d65383e.js", ["exports", "./chunk-12ee72ee.js"], function (e, t) { window.App.h; var r = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, n = new RegExp("[\\-\\.0-9" + r.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), i = new RegExp("^" + r.source + n.source + "*(?::" + r.source + n.source + "*)?$"), a = 0, o = 1, s = 2, l = 3, c = 4, u = 5, h = 6, f = 7; function d() { } function p(e, t) { return t.lineNumber = e.lineNumber, t.columnNumber = e.columnNumber, t; } function m(e, t, r, n, i, d) { for (var p, m = ++t, g = a;;) {
        ...
        try {
            ...
            switch ((N > b && o(N), e.charAt(N + 1))) {
                case "/":
                    ...
                    var k = I.localNSMap, A = I.tagName == x;
                    if (A || I.tagName && I.tagName.toLowerCase() == x.toLowerCase()) {
                        if (n.endElement(I.uri, I.localName, x), k)
                            for (var C in k)
                                n.endPrefixMapping(C);
                        A || i.fatalError("end tag name: " + x + " is not match the current start tagName:" + I.tagName);
                    }
                    else
                        f.push(I);
                    T++;
...
} } function J() { } function Q(e, t) { for (var r = e.length; r--;)
    if (e[r] === t)
        return r; } function ee(e, t, r, n) { if (n ? t[Q(t, n)] = r : t[t.length++] = r, e) {
    r.ownerElement = e;
...
} } function te(e, t, r) { var n = Q(t, r); if (!(n >= 0))
    ...
    default: t.push("??", e.nodeName);
        ...
        Te(this[n], r, e, t); return r.join(""); } }, $.prototype.item = function (e) { return q(this), this[e]; }, I($, X), J.prototype = { length: 0, item: X.prototype.item, getNamedItem: function (e) { for (var t = this.length; t--;) {
        var r = this[t];
        if (r.nodeName == e)
            return r;
        ...
        case C:
            var s = r.attributes, l = i.attributes = new J, c = s.length;
            l._ownerElement = i;
            for (var u = 0; u < c; u++)
...
catch (e) { } var Ie, ke = re, Ae = Ne, Ce = { DOMImplementation: ke, XMLSerializer: Ae }, Oe = Object.freeze({ default: Ce, __moduleExports: Ce, DOMImplementation: ke, XMLSerializer: Ae }), Re = T && D || T, Le = Oe && Ce || Oe, Me = t.createCommonjsModule(function (e, t) { function r(e) { this.options = e || { locator: {} }; } function n() { this.cdata = !1; } function i(e, t) { t.lineNumber = e.lineNumber, t.columnNumber = e.columnNumber; } function a(e) { if (e)
    ...
    We[Ye[Ie]] = parseInt(Ie); "undefined" == typeof window ? He = function (e) { return (new (0, Ge.DOMParser)).parseFromString(e, "text/xml"); } : void 0 !== window.DOMParser ? He = function (e) { return (new window.DOMParser).parseFromString(e, "text/xml"); } : void 0 !== window.ActiveXObject && new window.ActiveXObject("Microsoft.XMLDOM") && (He = function (e) { var t = new window.ActiveXObject("Microsoft.XMLDOM"); return t.async = "false", t.loadXML(e), t; }); var Xe = { fieldTags: Ke, fieldTagNames: Ze, arrayFields: Ve, fieldTypes: ze, fieldTypeNames: je, photometricInterpretations: { WhiteIsZero: 0, BlackIsZero: 1, RGB: 2, Palette: 3, TransparencyMask: 4, CMYK: 5, YCbCr: 6, CIELab: 8, ICCLab: 9 }, geoKeys: We, geoKeyNames: Ye, parseXml: He }, $e = Xe.fieldTags, qe = Xe.fieldTagNames, Je = Xe.arrayFields, Qe = Xe.fieldTypes, et = Xe.fieldTypeNames, tt = Xe.photometricInterpretations, rt = Xe.geoKeys, nt = Xe.geoKeyNames, it = Xe.parseXml, at = Object.freeze({ default: Xe, __moduleExports: Xe, fieldTags: $e, fieldTagNames: qe, arrayFields: Je, fieldTypes: Qe, fieldTypeNames: et, photometricInterpretations: tt, geoKeys: rt, geoKeyNames: nt, parseXml: it }), ot = { fromWhiteIsZero: function (e, t, r, n) { for (var i, a = new Uint8Array(r * n * 3), o = 0, s = 0; o < e.length; ++o, s += 3)
    ...
    if (r) {
        ...
        e[i + a] = t[r + a]; }, flattenChunks: function (e) { return [].concat.apply([], e); } }; t.setTyped = function (e) { e ? (t.Buf8 = Uint8Array, t.Buf16 = Uint16Array, t.Buf32 = Int32Array, t.assign(t, i)) : (t.Buf8 = Array, t.Buf16 = Array, t.Buf32 = Array, t.assign(t, a)); }, t.setTyped(r); }), Tt = Dt.assign, xt = Dt.shrinkBuf, It = Dt.setTyped, kt = Dt.Buf8, At = Dt.Buf16, Ct = Dt.Buf32, Ot = Object.freeze({ default: Dt, __moduleExports: Dt, assign: Tt, shrinkBuf: xt, setTyped: It, Buf8: kt, Buf16: At, Buf32: Ct }), Rt = function (e, t, r, n) { for (var i = 65535 & e | 0, a = e >>> 16 & 65535 | 0, o = 0; 0 !== r;) {
    r -= o = r > 2e3 ? 2e3 : r;
    do {
        a = a + (i = i + t[n++] | 0) | 0;
    } while (--o);
...
} while (n < i && a < s); n -= _ = p >> 3, d &= (1 << (p -= _ << 3)) - 1, e.next_in = n, e.next_out = a, e.avail_in = n < i ? i - n + 5 : 5 - (n - i), e.avail_out = a < s ? s - a + 257 : 257 - (a - s), r.hold = d, r.bits = p; }, Pt = Object.freeze({ default: Ut, __moduleExports: Ut }), Gt = Ot && Dt || Ot, Zt = [3, 4, 5, 6, 7, 8, 9, 10, 11, 13, 15, 17, 19, 23, 27, 31, 35, 43, 51, 59, 67, 83, 99, 115, 131, 163, 195, 227, 258, 0, 0], Kt = [16, 16, 16, 16, 16, 16, 16, 16, 17, 17, 17, 17, 18, 18, 18, 18, 19, 19, 19, 19, 20, 20, 20, 20, 21, 21, 21, 21, 16, 72, 78], Vt = [1, 2, 3, 4, 5, 7, 9, 13, 17, 25, 33, 49, 65, 97, 129, 193, 257, 385, 513, 769, 1025, 1537, 2049, 3073, 4097, 6145, 8193, 12289, 16385, 24577, 0, 0], jt = [16, 16, 16, 16, 17, 17, 18, 18, 19, 19, 20, 20, 21, 21, 22, 22, 23, 23, 24, 24, 25, 25, 26, 26, 27, 27, 28, 28, 29, 29, 64, 64], zt = function (e, t, r, n, i, a, o, s) { var l, c, u, h, f, d, p, m, g, w = s.bits, y = 0, b = 0, v = 0, _ = 0, E = 0, N = 0, S = 0, D = 0, T = 0, x = 0, I = null, k = 0, A = new Gt.Buf16(16), C = new Gt.Buf16(16), O = null, R = 0; for (y = 0; y <= 15; y++)
    A[y] = 0; for (b = 0; b < n; b++)
    ...
    0 !== t[r + b] && (o[C[t[r + b]]++] = b); if (0 === e ? (I = O = o, d = 19) : 1 === e ? (I = Zt, k -= 257, O = Kt, R -= 257, d = 256) : (I = Vt, O = jt, d = -1), x = 0, b = 0, y = v, f = a, N = E, S = 0, u = -1, h = (T = 1 << E) - 1, 1 === e && T > 852 || 2 === e && T > 592)
    return 1; for (;;) {
    p = y - S, o[b] < d ? (m = 0, g = o[b]) : o[b] > d ? (m = O[R + o[b]], g = I[k + o[b]]) : (m = 96, g = 0), l = 1 << y - S, v = c = 1 << N;
    do {
...
} return 0 !== x && (i[f + x] = y - S << 24 | 64 << 16 | 0), s.bits = E, 0; }, Ht = Object.freeze({ default: zt, __moduleExports: zt }), Yt = Lt && Rt || Lt, Wt = Bt && Ft || Bt, Xt = Pt && Ut || Pt, $t = Ht && zt || Ht, qt = 1, Jt = 2, Qt = 0, er = -2, tr = 1, rr = 852, nr = 592; function ir(e) { return (e >>> 24 & 255) + (e >>> 8 & 65280) + ((65280 & e) << 8) + ((255 & e) << 24); } function ar(e) { var t; return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = tr, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new Gt.Buf32(rr), t.distcode = t.distdyn = new Gt.Buf32(nr), t.sane = 1, t.back = -1, Qt) : er; } function or(e) { var t; return e && e.state ? ((t = e.state).wsize = 0, t.whave = 0, t.wnext = 0, ar(e)) : er; } function sr(e, t) { var r, n; return e && e.state ? (n = e.state, t < 0 ? (r = 0, t = -t) : (r = 1 + (t >> 4), t < 48 && (t &= 15)), t && (t < 8 || t > 15) ? er : (null !== n.window && n.wbits !== t && (n.window = null), n.wrap = r, n.wbits = t, or(e))) : er; } function lr(e, t) { var r, n; return e ? (n = new function () { this.mode = 0, this.last = !1, this.wrap = 0, this.havedict = !1, this.flags = 0, this.dmax = 0, this.check = 0, this.total = 0, this.head = null, this.wbits = 0, this.wsize = 0, this.whave = 0, this.wnext = 0, this.window = null, this.hold = 0, this.bits = 0, this.length = 0, this.offset = 0, this.extra = 0, this.lencode = null, this.distcode = null, this.lenbits = 0, this.distbits = 0, this.ncode = 0, this.nlen = 0, this.ndist = 0, this.have = 0, this.next = null, this.lens = new Gt.Buf16(320), this.work = new Gt.Buf16(288), this.lendyn = null, this.distdyn = null, this.sane = 0, this.back = 0, this.was = 0; }, e.state = n, n.window = null, (r = sr(e, t)) !== Qt && (e.state = null), r) : er; } var cr, ur, hr = !0; function fr(e) { if (hr) {
    var t;
    ...
    for ($t(qt, e.lens, 0, 288, cr, 0, e.work, { bits: 9 }), t = 0; t < 32;)
        e.lens[t++] = 5;
    $t(Jt, e.lens, 0, 32, ur, 0, e.work, { bits: 5 }), hr = !1;
    ...
    return er; 12 === (r = e.state).mode && (r.mode = 13), o = e.next_out, i = e.output, l = e.avail_out, a = e.next_in, n = e.input, s = e.avail_in, c = r.hold, u = r.bits, h = s, f = l, N = Qt; e: for (;;)
    switch (r.mode) {
        case tr:
            if (0 === r.wrap) {
                r.mode = 13;
        ...
        case 19:
            ...
            if (r.distbits = 6, r.distcode = r.distdyn, S = { bits: r.distbits }, N = $t(Jt, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, S), r.distbits = S.bits, N) {
    ...
    xr = !1;
} for (var Ir = new Gt.Buf8(256), kr = 0; kr < 256; kr++)
    Ir[kr] = kr >= 252 ? 6 : kr >= 248 ? 5 : kr >= 240 ? 4 : kr >= 224 ? 3 : kr >= 192 ? 2 : 1; Ir[254] = Ir[254] = 1; var Ar = function (e) { var t, r, n, i, a, o = e.length, s = 0; for (i = 0; i < o; i++)
        ...
        for (var y = u; y < h; ++y)
            for (var b = l; b < c; ++b)
                for (var v = y * s, _ = b * o, E = (y + 1) * s, N = (b + 1) * o, S = 0; S < t.length; ++S) {
                    ...
                    var T = new DataView(this.getTileOrStrip(b, y, D)), x = g[S], I = Math.min(s, s - (E - e[3])), k = Math.min(o, o - (N - e[2])), A = (I * o + k) * d, C = new Uint8Array(T.buffer).length;
                    2 * C !== A && this._debugMessages && console.warn("dimension mismatch", C, A);
                    for (var O = Math.max(0, e[1] - v); O < I; ++O)
                        for (var R = Math.max(0, e[0] - _); R < k; ++R) {
                            var L, M = (O * o + R) * d, F = 0;
    ...
    r = e;
} return new hi(r, t); }; e.exports.parse = t, "undefined" != typeof window && (window.GeoTIFF = { parse: t }); }).parse; e.getSetting = function (e) { try {
    return JSON.parse(localStorage.getItem(e));
}
catch (e) {
    return;
} }, e.setSetting = function (e, t) { localStorage.setItem(e, JSON.stringify(t)); }, e.getCurrentCoord = function (e, t) {
...
}, e.getExtends = function (e) { return [e.log - e.angle, e.lat - e.angle, e.log + e.angle, e.lat + e.angle]; }, e.average = function (e) { return e.reduce(function (e, t) { return t + e; }, 0) / e.length; }, e.insertQuery = function (e, t) {
    return __awaiter(this, void 0, void 0, function () { var r, n; return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
