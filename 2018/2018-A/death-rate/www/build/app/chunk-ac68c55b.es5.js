...
App.loadBundle("chunk-ac68c55b.js", ["exports", "./chunk-12ee72ee.js"], function (e, t) { window.App.h; var r = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, n = new RegExp("[\\-\\.0-9" + r.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), i = new RegExp("^" + r.source + n.source + "*(?::" + r.source + n.source + "*)?$"), a = 0, o = 1, s = 2, l = 3, c = 4, u = 5, h = 6, f = 7; function d() { } function p(e, t) { return t.lineNumber = e.lineNumber, t.columnNumber = e.columnNumber, t; } function m(e, t, r, n, i, d) { for (var p, m = ++t, g = a;;) {
...
} r.constructor != e && ("function" != typeof e && console.error("unknow Class:" + e), r.constructor = e); } var A = "http://www.w3.org/1999/xhtml", k = {}, C = k.ELEMENT_NODE = 1, O = k.ATTRIBUTE_NODE = 2, R = k.TEXT_NODE = 3, F = k.CDATA_SECTION_NODE = 4, L = k.ENTITY_REFERENCE_NODE = 5, M = k.ENTITY_NODE = 6, B = k.PROCESSING_INSTRUCTION_NODE = 7, P = k.COMMENT_NODE = 8, U = k.DOCUMENT_NODE = 9, G = k.DOCUMENT_TYPE_NODE = 10, Z = k.DOCUMENT_FRAGMENT_NODE = 11, K = k.NOTATION_NODE = 12, V = {}, j = {}, z = (V.INDEX_SIZE_ERR = (j[1] = "Index size error", 1), V.DOMSTRING_SIZE_ERR = (j[2] = "DOMString size error", 2), V.HIERARCHY_REQUEST_ERR = (j[3] = "Hierarchy request error", 3)), H = (V.WRONG_DOCUMENT_ERR = (j[4] = "Wrong document", 4), V.INVALID_CHARACTER_ERR = (j[5] = "Invalid character", 5), V.NO_DATA_ALLOWED_ERR = (j[6] = "No data allowed", 6), V.NO_MODIFICATION_ALLOWED_ERR = (j[7] = "No modification allowed", 7), V.NOT_FOUND_ERR = (j[8] = "Not found", 8)), Y = (V.NOT_SUPPORTED_ERR = (j[9] = "Not supported", 9), V.INUSE_ATTRIBUTE_ERR = (j[10] = "Attribute in use", 10)); function W(e, t) { if (t instanceof Error)
    var r = t;
else
    ...
    case P: return t.push("\x3c!--", e.data, "--\x3e");
    case G:
    ...
    default: t.push("??", e.nodeName);
        ...
        if (r && e in r)
            return r[e];
        t = t.nodeType == O ? t.ownerDocument : t.parentNode;
    } return null; }, isDefaultNamespace: function (e) { return null == this.lookupPrefix(e); } }, x(k, ne), x(k, ne.prototype), oe.prototype = { nodeName: "#document", nodeType: U, doctype: null, documentElement: null, _inc: 1, insertBefore: function (e, t) { if (e.nodeType == Z) {
    ...
    e = e >>> 8 ^ i[255 & (e ^ t[o])]; return -1 ^ e; }, Bt = Object.freeze({ default: Mt, __moduleExports: Mt }), Pt = function (e, t) { var r, n, i, a, o, s, l, c, u, h, f, d, p, m, g, w, y, b, v, _, E, N, S, D, T; r = e.state, n = e.next_in, D = e.input, i = n + (e.avail_in - 5), a = e.next_out, T = e.output, o = a - (t - e.avail_out), s = a + (e.avail_out - 257), l = r.dmax, c = r.wsize, u = r.whave, h = r.wnext, f = r.window, d = r.hold, p = r.bits, m = r.lencode, g = r.distcode, w = (1 << r.lenbits) - 1, y = (1 << r.distbits) - 1; e: do {
    ...
    r--; return r < 0 ? t : 0 === r ? t : r + Ir[e[r]] > t ? r : t; }, Mr = { string2buf: kr, buf2binstring: Or, binstring2buf: Rr, buf2string: Fr, utf8border: Lr }, Br = Object.freeze({ default: Mr, __moduleExports: Mr, string2buf: kr, buf2binstring: Or, binstring2buf: Rr, buf2string: Fr, utf8border: Lr }), Pr = { Z_NO_FLUSH: 0, Z_PARTIAL_FLUSH: 1, Z_SYNC_FLUSH: 2, Z_FULL_FLUSH: 3, Z_FINISH: 4, Z_BLOCK: 5, Z_TREES: 6, Z_OK: 0, Z_STREAM_END: 1, Z_NEED_DICT: 2, Z_ERRNO: -1, Z_STREAM_ERROR: -2, Z_DATA_ERROR: -3, Z_BUF_ERROR: -5, Z_NO_COMPRESSION: 0, Z_BEST_SPEED: 1, Z_BEST_COMPRESSION: 9, Z_DEFAULT_COMPRESSION: -1, Z_FILTERED: 1, Z_HUFFMAN_ONLY: 2, Z_RLE: 3, Z_FIXED: 4, Z_DEFAULT_STRATEGY: 0, Z_BINARY: 0, Z_TEXT: 1, Z_UNKNOWN: 2, Z_DEFLATED: 8 }, Ur = Pr.Z_NO_FLUSH, Gr = Pr.Z_PARTIAL_FLUSH, Zr = Pr.Z_SYNC_FLUSH, Kr = Pr.Z_FULL_FLUSH, Vr = Pr.Z_FINISH, jr = Pr.Z_BLOCK, zr = Pr.Z_TREES, Hr = Pr.Z_OK, Yr = Pr.Z_STREAM_END, Wr = Pr.Z_NEED_DICT, Xr = Pr.Z_ERRNO, $r = Pr.Z_STREAM_ERROR, qr = Pr.Z_DATA_ERROR, Qr = Pr.Z_BUF_ERROR, Jr = Pr.Z_NO_COMPRESSION, en = Pr.Z_BEST_SPEED, tn = Pr.Z_BEST_COMPRESSION, rn = Pr.Z_DEFAULT_COMPRESSION, nn = Pr.Z_FILTERED, an = Pr.Z_HUFFMAN_ONLY, on = Pr.Z_RLE, sn = Pr.Z_FIXED, ln = Pr.Z_DEFAULT_STRATEGY, cn = Pr.Z_BINARY, un = Pr.Z_TEXT, hn = Pr.Z_UNKNOWN, fn = Pr.Z_DEFLATED, dn = Object.freeze({ default: Pr, __moduleExports: Pr, Z_NO_FLUSH: Ur, Z_PARTIAL_FLUSH: Gr, Z_SYNC_FLUSH: Zr, Z_FULL_FLUSH: Kr, Z_FINISH: Vr, Z_BLOCK: jr, Z_TREES: zr, Z_OK: Hr, Z_STREAM_END: Yr, Z_NEED_DICT: Wr, Z_ERRNO: Xr, Z_STREAM_ERROR: $r, Z_DATA_ERROR: qr, Z_BUF_ERROR: Qr, Z_NO_COMPRESSION: Jr, Z_BEST_SPEED: en, Z_BEST_COMPRESSION: tn, Z_DEFAULT_COMPRESSION: rn, Z_FILTERED: nn, Z_HUFFMAN_ONLY: an, Z_RLE: on, Z_FIXED: sn, Z_DEFAULT_STRATEGY: ln, Z_BINARY: cn, Z_TEXT: un, Z_UNKNOWN: hn, Z_DEFLATED: fn }), pn = { 2: "need dictionary", 1: "stream end", 0: "", "-1": "file error", "-2": "stream error", "-3": "data error", "-4": "insufficient memory", "-5": "buffer error", "-6": "incompatible version" }, mn = Object.freeze({ default: pn, __moduleExports: pn }), gn = function () { this.input = null, this.next_in = 0, this.avail_in = 0, this.total_in = 0, this.output = null, this.next_out = 0, this.avail_out = 0, this.total_out = 0, this.msg = "", this.state = null, this.data_type = 2, this.adler = 0; }, wn = Object.freeze({ default: gn, __moduleExports: gn }), yn = function () { this.text = 0, this.time = 0, this.xflags = 0, this.os = 0, this.extra = null, this.extra_len = 0, this.name = "", this.comment = "", this.hcrc = 0, this.done = !1; }, bn = Object.freeze({ default: yn, __moduleExports: yn }), vn = Dr && Sr || Dr, _n = Br && Mr || Br, En = dn && Pr || dn, Nn = mn && pn || mn, Sn = wn && gn || wn, Dn = bn && yn || bn, Tn = Object.prototype.toString; function xn(e) { if (!(this instanceof xn))
...
} return new Uint8Array(i).buffer; }; var Gn = Un, Zn = Object.freeze({ default: Gn, __moduleExports: Gn }), Kn = at && Xe || at, Vn = dt && ot || dt, jn = vt && bt || vt, zn = St && Nt || St, Hn = Pn && Bn || Pn, Yn = Zn && Gn || Zn, Wn = function (e, t, r) { for (var n = 0, i = t; i < r; ++i)
    ...
    r = e;
} return new hi(r, t); }; e.exports.parse = t, "undefined" != typeof window && (window.GeoTIFF = { parse: t }); }).parse; var di = "http://itastdevserver.tel.uva.es", pi = "Basic Z3J1cG8yMDE4QTpncjE4QXh6"; function mi(e) { try {
    return JSON.parse(localStorage.getItem(e));
}
catch (e) {
    return;
} } e.getSetting = mi, e.setSetting = function (e, t) { localStorage.setItem(e, JSON.stringify(t)); }, e.getCurrentCoord = function (e, t) {
