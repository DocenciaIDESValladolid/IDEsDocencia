...
var configLayersData = [
  ...
  layerGraveyard = {
    ...
    getWFS(minLon, minLat, maxLon, maxLat) {
      return 'https://wxs.ign.fr/k3p0n69vbaaonaamhydsqw3f/geoportail/wfs?REQUEST=GetFeature&VERSION=1.1.0&TYPENAME=BDCARTO_BDD_WLD_WGS84G:cimetiere&bbox=' + minLat + ',' + minLon + ',' + maxLat + ',' + maxLon + '&srs=EPSG:4326';
    },
    getXML(minLon, minLat, maxLon, maxLat) {
  ...
  layerHealth = {
    ...
    getWFS(minLon, minLat, maxLon, maxLat) {
      return 'https://wxs.ign.fr/k3p0n69vbaaonaamhydsqw3f/geoportail/wfs?REQUEST=GetFeature&VERSION=1.1.0&TYPENAME=BDTOPO_BDD_WLD_WGS84G:pai_sante&bbox=' + minLat + ',' + minLon + ',' + maxLat + ',' + maxLon + '&srs=EPSG:4326';
    },
    getXML(minLon, minLat, maxLon, maxLat) {
  ...
  layerReligious = {
    ...
    getWFS(minLon, minLat, maxLon, maxLat) {
      return 'https://wxs.ign.fr/k3p0n69vbaaonaamhydsqw3f/geoportail/wfs?REQUEST=GetFeature&VERSION=1.1.0&TYPENAME=BDTOPO_BDD_WLD_WGS84G:pai_religieux&bbox=' + minLon + ',' + minLat + ',' + maxLon + ',' + maxLat + '&srs=EPSG:4326';
    },
    getXML(minLon, minLat, maxLon, maxLat) {
  ...
  layerMilitary = {
    ...
    style: new ol.style.Style({
     image: new ol.style.Icon({
        scale: 0.2,
        //src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Mil_Land_Vehicle_Icon.svg/200px-Mil_Land_Vehicle_Icon.svg.png'
        src: 'http://icons.iconarchive.com/icons/aha-soft/free-large-boss/256/Army-Officer-icon.png'
      })
    }),
    infectionProbability: 0,
    getWFS(minLon, minLat, maxLon, maxLat) {
      return 'https://wxs.ign.fr/k3p0n69vbaaonaamhydsqw3f/geoportail/wfs?REQUEST=GetFeature&VERSION=1.1.0&TYPENAME=BDTOPO_BDD_WLD_WGS84G:pai_administratif_militaire&bbox=' + minLat + ',' + minLon + ',' + maxLat + ',' + maxLon + '&srs=EPSG:4326';
    },
    getXML(minLon, minLat, maxLon, maxLat) {
