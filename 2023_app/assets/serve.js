...
var geoserverProxy =  createProxyMiddleware('/geoserver', {target: 'http://localhost:8090'});
app.use(geoserverProxy);
var mirameProxy =  createProxyMiddleware('/mirame', {target: 'http://www.mirame.chduero.es', 
									pathRewrite: {
