...
$('#mappage').on("pageinit", function(){
    //Declaramos la variable global que nos permita saber si hay ruta creada o no
    routeCreated=false;
    traceroute=0;
    proj4.defs("EPSG:4258","+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_defs");
	proj4.defs("urn:ogc:def:crs:EPSG::4258","+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_defs");
     
    show_functions();
    initmap();
    initApp();
	showFullRoute(); //funcion para pintar la ruta sobre el mapa
    getOriginKM();
