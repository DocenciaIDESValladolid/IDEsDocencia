...
var resultados=gmlParser.read(geomGml);*/
	...
	<xls:RoutePlan>
		<xlsext:GraphName>Voiture</xlsext:GraphName>
            ...
            <xls:WayPointList>
            	<xls:StartPoint>
                	<xls:Position>
                		<gml:Point srsName="EPSG:3857"><gml:pos>${latinit} ${loninit}</gml:pos></gml:Point>
                    </xls:Position>
                </xls:StartPoint>
                <xls:EndPoint>
                	<xls:Position>
                        <gml:Point srsName="EPSG:3857"><gml:pos>${lat} ${lon}</gml:pos></gml:Point>
                    </xls:Position>
                </xls:EndPoint>
            </xls:WayPointList>
    </xls:RoutePlan>
...
//var olsserver='http://wxs.ign.fr/1tqlxrqh5kdy2lgh6kmpiuhh/itineraire/ols';
...
var request = new OpenLayers.Request.POST({
        ...
        callback: function (response) {
            ...
            var features = readFeaturesFromWPSResponse(response.responseText);

			// features debe tener una coleccion de features con la ruta
			getAnalysisFeatures(features);
